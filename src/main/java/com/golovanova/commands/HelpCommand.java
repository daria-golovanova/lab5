...
public class HelpCommand extends AbstractCommand {
    ...
    public HelpCommand() {
        super("help", "display help for available com.golovanova.commands");
    }

    public void execute() {
        System.out.println("help " + "display help for available com.golovanova.commands");
        ...
        System.out.println("history " + "print the last 11 com.golovanova.commands (without their arguments)");
        ...
        System.out.println("update id {element_id} " + "update the value of a collection " +
